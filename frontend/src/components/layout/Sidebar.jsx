...
export const NAV_ITEMS = [
  ...
  { id: 'class-timetable', path: 'orar-pe-clasa', label: 'Orar pe clasa', allowedRoles: ['secretariat', 'scheduler', 'director', 'sysadmin'] },
  { id: 'generate', path: 'genereaza-orar', label: 'Genereaza orar', allowedRoles: ['secretariat', 'scheduler', 'director', 'sysadmin'] },
  { id: 'users', path: 'utilizatori', label: 'Utilizatori', allowedRoles: ['secretariat', 'director', 'sysadmin'] },
  { id: 'create-account', path: 'creeaza-cont', label: 'Creeaza cont', allowedRoles: ['sysadmin'] },
  { id: 'catalog', path: 'catalog', label: 'Catalog', allowedRoles: ['student', 'parent', 'professor', 'secretariat', 'director', 'sysadmin'] },
